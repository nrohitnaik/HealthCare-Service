...
public class ReportingDaoImpl implements ReportingDao {
    ...
    public String generateInventoryReport() {
        ...
        report.columns(Columns.column("Inventory Id", "inventory_id", DataTypes.integerType()), Columns.column("Inventory Name", "name", DataTypes.stringType()),
                Columns.column("Description", "description", DataTypes.stringType()), Columns.column("quantity", "quantity", DataTypes.integerType()),
                Columns.column("Price per Unit", "price_per_unit", DataTypes.integerType()), Columns.column("Vendor Contact Info", "vendor_contact", DataTypes.stringType()),
                Columns.column("Type of Inventory", "type", DataTypes.stringType()))
                .title(// title of the report
                        Components.text("Inventory List").setHorizontalAlignment(HorizontalAlignment.CENTER))
    ...
    public String generateListOfDoctorReport() {
        ...
        report.columns(Columns.column("Registration Id", "registration_id", DataTypes.integerType()), Columns.column("First Name", "first_name", DataTypes.stringType()),
                Columns.column("Last Name", "last_name", DataTypes.stringType()), Columns.column("Specialization", "specialization", DataTypes.stringType()),
                Columns.column("Department", "department", DataTypes.stringType()), Columns.column("Qualification", "qualification", DataTypes.stringType()),
                Columns.column("Mobile Number", "mobile_no", DataTypes.integerType()), Columns.column("Email", "email", DataTypes.stringType()),
                Columns.column("Status", "status", DataTypes.stringType()))
                .title(// title of the report
                        Components.text("List of all the doctors").setHorizontalAlignment(HorizontalAlignment.CENTER))
                .pageFooter(Components.pageXofY())// show page number on the page footer
    ...
    public String generateDetailsOfAllPatient() {
        ...
        report.columns(Columns.column("Patient Id", "patient_id", DataTypes.integerType()), Columns.column("Patient First Name", "p_first_name", DataTypes.stringType()),
                Columns.column("Patient Last Name", "p_last_name", DataTypes.stringType()), Columns.column("Patient Date of Birth", "date_of_birth", DataTypes.dateType()),
                ...
                Columns.column("Doctor First Name", "d_first_name", DataTypes.stringType()), Columns.column("Doctor Last Name", "d_last_name", DataTypes.stringType()),
                Columns.column("Doctor Specialization", "specialization", DataTypes.stringType()),
                Columns.column("Department", "department", DataTypes.stringType()), Columns.column("Mobile Number", "mobile_no", DataTypes.integerType()),
    ...
    public String generateReportOfSinglePatient(int patientId) {
        ...
        report.columns(Columns.column("Patient Id", "patient_id", DataTypes.integerType()), Columns.column("Patient First Name", "p_first_name", DataTypes.stringType()),
                Columns.column("Patient Last Name", "p_last_name", DataTypes.stringType()), Columns.column("Patient Date of Birth", "date_of_birth", DataTypes.dateType()),
                Columns.column("Patient mentioned Illness", "illness", DataTypes.stringType()),
                Columns.column(" Doctor Registration Id", "registration_id", DataTypes.integerType()), Columns.column("Doctor First Name", "d_first_name", DataTypes.stringType()),
                Columns.column("Doctor Last Name", "d_last_name", DataTypes.stringType()), Columns.column("Doctor Specialization", "specialization", DataTypes.stringType()),
                Columns.column("Department", "department", DataTypes.stringType()), Columns.column("Mobile Number", "mobile_no", DataTypes.integerType()),
                Columns.column("Doctor Treatment prescription", "prescription", DataTypes.stringType()), Columns.column("Diagnosis Status", "status", DataTypes.stringType()))
                .title(// title of the report
                        Components.text("List of all the Patients treated").setHorizontalAlignment(HorizontalAlignment.CENTER))
